    ...
    methods (Access = public)
        ...
        function A = isovolumic(C, t, isSevere)
            ...
            if (isSevere == 1) 
                ...
                0 1/(elR*C.R7)-delR_dt/(elR*C.R7) 0 -1/(elR*C.R7) 0 0 0; %x2'
                0 0 0 0 0 0 0; %x3'
                0 1/(elL*C.R7) 0 -1/(elL*C.R7)-delL_dt/(elL*C.R7) 0 0 0; %x4'
        ...
        function A = filling(C, t, isSevere)
            ...
            A = [(1/(C.R8*C.C1)-1/(C.R1*C.R8)) -1/(C.C1*C.R1) 0 0 -1/(C.R8*C.C1) 0 0; %x1'
                -elR/C.R1 -elR/delR_dt+elR/C.R7+elR/C.R1 0 -elR/C.R7 0 0 0; %x2'
                0 0 1/(C.C3*C.R4) -1/(C.C3*C.R4) 0 0 0; %x3'
                0 -elL/C.R7 -elL/(C.R4) (elL/C.R4+elL/C.R7-elL/delL_dt) 0 0 0; %x4'
                1/(C.C5*C.R8) 0 0 0 -1/(C.C5*C.R8) 0 0; %x5'
                0 0 0 0 0 0 0; %x6'
                0 0 0 0 0 0 0]; %x7'
        end
...
%                  0 0 0 -1/C.L2 -1/C.L2 0 -(C.R5+C.R6)/C.L2]; %x7'
              A = [1/(C.C1*C.R8) 0 0 0 -1/(C.C1*C.R8) 0 0; %x1'
                 0 (elR/-delR_dt+elR/C.R7) 0 -elR/C.R7 0 elR 0; %x2'
                 0 0 0 0 0 1/C.C3 0; %x3'
                 0 -elL*C.R7 0 (-elL/delL_dt+elL/C.R7)  0 0 elL; %x4'
                 -1/(C.C5*C.R8) 0 0 0 1/(C.R8*C.C5) 0 1/C.C5; %x5'
                 0 -1/C.L1 1/C.L1 0 0 -(C.R2+C.R3)/C.L1 0; %x6'
                 0 0 0 -1/C.L2 1/C.L2 0 -(C.R5+C.R6)/C.L2]; %x7'
        end
